...
uint8_t I2C_ReadByteFromSlave(uint8_t I2C_Addr, uint8_t reg, uint8_t* buffer) {
    ...
    I2C_AcknowledgeConfig(I2C2, DISABLE); // Tat ACK truoc khi nhan byte cuoi
    timeout = 1000;
    ...
    *buffer = I2C_ReceiveData(I2C2);
    I2C_GenerateSTOP(I2C2, ENABLE);
    I2C_AcknowledgeConfig(I2C2, ENABLE); // Bat lai ACK cho lan sau
    return 0;
}
...
void MPU6050_Configuration(){
	...
	I2C_WriteByteToSlave(MPU_ADDRESS,MPU6050_GYRO_CONFIG,0x18); // 2000
	I2C_WriteByteToSlave(MPU_ADDRESS,MPU6050_ACCEL_CONFIG,0x01); // 2g
}
